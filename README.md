...
Converts user-provided text or spoken audio into Indian Sign Language using pre-generated 2D animated ISL videos. This module ensures uniform and consistent gesture representation, rather than using raw human videos.
